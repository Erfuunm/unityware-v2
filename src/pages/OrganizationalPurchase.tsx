  ...
  <div>
    ...
    <section className="py-24 bg-background">
      <div className="container">
        ...
        <SectionHeading title="Request a Quote" subtitle="Fill in your details and our team will get back to you within 24 hours." />
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Input placeholder="Organization Name" defaultValue="Metro Health Clinic" />
            <Input placeholder="Contact Person" defaultValue="John Doe" />
            <Input type="email" placeholder="Email" defaultValue="john@metrohealth.com" />
            <Input type="tel" placeholder="Phone" defaultValue="+1 (555) 987-6543" />
          </div>
          <Textarea placeholder="Products of Interest & Quantity" rows={4} defaultValue="3D Foot Scanner x5, Insole 3D Printer x2, Pressure Platform x3" />
          <Textarea placeholder="Additional Notes" rows={3} defaultValue="We need installation and training for our staff of 12 technicians." />
